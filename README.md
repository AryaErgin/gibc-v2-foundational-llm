...
See [RESULTS.md](RESULTS.md), [EXPERIMENT_LOG.md](EXPERIMENT_LOG.md), [ARCHITECTURE.md](ARCHITECTURE.md), [DATA_SOURCES.md](DATA_SOURCES.md), and [results/EXP-012-summary.md](results/EXP-012-summary.md). Benchmark evaluation is permitted only after a checkpoint is selected by the frozen validation-based promotion rule; benchmark results must not select checkpoints or tune training.
