...
def _validate_controlled_experiment(config: ExperimentConfig) -> None:
    ...
    if (
        ...
        or model.activation != ("swiglu" if config.experiment_id in {"EXP-008A", "EXP-009A", "EXP-009B", "EXP-010A", "EXP-011", "EXP-018", "EXP-019", "EXP-020", "EXP-012", "EXP-013-C", "EXP-013-W", "EXP-013-C43", "EXP-013-W43", "EXP-014", "EXP-016-C", "EXP-016-M", "EXP-017A"} else "gelu")
    ...
    if config.experiment_id == "EXP-018":
        if not model.qk_norm or model.qk_norm_epsilon != 1.0e-6:
    ...
    if config.experiment_id in {"EXP-005A", "EXP-005B", "EXP-006", "EXP-007A", "EXP-007B", "EXP-008A", "EXP-009A", "EXP-009B", "EXP-010A", "EXP-011", "EXP-018", "EXP-019", "EXP-020", "EXP-012", "EXP-013-C", "EXP-013-W", "EXP-013-C43", "EXP-013-W43", "EXP-014", "EXP-016-C", "EXP-016-M", "EXP-017A"} and (
    ...
    if config.experiment_id in {"EXP-004", "EXP-005A", "EXP-005B", "EXP-006", "EXP-007A", "EXP-007B", "EXP-008A", "EXP-009A", "EXP-009B", "EXP-010A", "EXP-011", "EXP-018", "EXP-019", "EXP-020", "EXP-012", "EXP-013-C", "EXP-013-W", "EXP-013-C43", "EXP-013-W43", "EXP-014", "EXP-016-C", "EXP-016-M", "EXP-017A"}:
        target_prediction_tokens = (
            ...
            else {"fineweb": 4_799_987_712, "fineweb_edu": 2_399_993_856}
