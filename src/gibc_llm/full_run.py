...
EXP011_ID = "EXP-011"
EXP012_ID = "EXP-012"
EXP013_IDS = {"EXP-013-C", "EXP-013-W"}
EXP006_ID = "EXP-006"
...
def load_full_run_artifact(artifact_dir: Path, config: ExperimentConfig) -> FullRunArtifact:
    ...
    expected_manifest_id = "EXP-004" if config.experiment_id in {*EXP005_IDS, *EXP007_IDS, *EXP008_IDS, *EXP009_IDS, *EXP010_IDS, *EXP013_IDS} else config.experiment_id
    ...
    dual_validation_experiment = config.experiment_id in {"EXP-003", "EXP-004", *EXP005_IDS, *EXP007_IDS, *EXP008_IDS, *EXP009_IDS, *EXP010_IDS, *EXP013_IDS, EXP006_ID, EXP011_ID, EXP012_ID}
    ...
    if config.experiment_id in {*EXP005_IDS, *EXP007_IDS, *EXP008_IDS, *EXP009_IDS, *EXP010_IDS, *EXP013_IDS} and packed.get("train_stream_sha256") != EXP004_FROZEN_STREAM_SHA256:
    ...
    if dual_validation_experiment:
        ...
        expected_edu_hashes = (
            ...
            if config.experiment_id in {"EXP-004", *EXP005_IDS, *EXP007_IDS, *EXP008_IDS, *EXP009_IDS, *EXP010_IDS, *EXP013_IDS, EXP006_ID, EXP011_ID, EXP012_ID}
