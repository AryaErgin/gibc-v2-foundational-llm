...
| Fresh 2.4B calibration | EXP-012 completed 2,399,993,856 prediction tokens; the final approximately-300M tranche is approaching diminishing returns. | [EXP-012](results/EXP-012-summary.md) |

No official benchmark has run. A promotable checkpoint must be selected by frozen validation-based research review; benchmark results cannot select the checkpoint.
