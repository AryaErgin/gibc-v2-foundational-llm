...
| Public reproducibility | [Public weights](https://huggingface.co/AryaErgin/gibc-v2-exp020) and anonymous hash verification complete; current source changes await authorized commit/tag/push |
...
| Public source repository with setup/usage | Root canonical docs ready; publish reviewed source separately, no push performed |
...
| At least three high-quality images | Four existing 1280×720 PNGs plus SVGs; [caption/source map](../assets/exp020/README.md). Use trajectory, progression, decisions; pipeline is a fourth candidate. |
...
- Model hosting and its anonymous hash check are complete; final source publication and Devpost field completion remain manual.
